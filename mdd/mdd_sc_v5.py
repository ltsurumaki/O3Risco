...
data_csv = yesterday.strftime("%d%b%Y")
prop_quali = pd.read_excel('I:/Riscos/Maxdrawdown/prop.xlsx')
prop_quali = prop_quali[prop_quali['Origin']=='O3 MACRO INTERNATIONAL FUND']
...
tgc_off['Amount'] = tgc_off['Amount'].bfill() 
...
#tgc_off['tgc_off'] = tgc_off['pl_total']/(tgc_off['position_close'].shift(1)*(tgc_off['Amount'].shift(1)/100)*pct_tgc_off/tgc_off['brl_curncy'].shift(1))
